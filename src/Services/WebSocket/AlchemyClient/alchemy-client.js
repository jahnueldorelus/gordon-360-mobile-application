...
export function Alchemy(options) {
  // Modernizr is not installed
  const Modernizr = undefined;
...
Alchemy.prototype = {
  ...
  Start: function () {
    var server =
      ...
      ":" +
      this._options.Port +
      (this._options.Action ? "/" + this._options.Action : "") +
      (this._options.SocketType ? "/" + this._options.SocketType : "");
    var ACInstance = this;
